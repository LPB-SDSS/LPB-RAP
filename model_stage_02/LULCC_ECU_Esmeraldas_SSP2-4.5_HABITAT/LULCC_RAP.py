...
habitat_analysis_outputs_folder = Filepaths.folder_habitat_analysis_RAP_outputs
...
if habitat_analysis_dictionary['do_habitat_analysis'] == True:
    if habitat_connectivity_simulation_dictionary['simulate_connectivity'] == True or PHC_simulation_dictionary['simulate_PHCs'] == True:
        if (habitat_connectivity_simulation_dictionary['simulation_in'] == 'RAP' or habitat_connectivity_simulation_dictionary['simulation_in'] == 'mplc+RAP') or (PHC_simulation_dictionary['simulation_in'] == 'RAP' or PHC_simulation_dictionary['simulation_in'] == 'mplc+RAP'):
            ...
            if LPBRAP_Omniscape_settings_dictionary['simulation_buffer_integrated'] == False:
                ...
                def _setclone_extended():
                    ...
                    numpy_raster_padded_map = numpy2pcr(dataType=pcraster.Scalar,
                                                        ...
                                                        mv=-9999)
                    report_setclone_extended_input_map_path = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs, 'setclone_extended_input.map')
...
class PossibleLandscapeConfiguration(DynamicModel):
    ...
    def _prepare_tidy_output(self):
        ...
        if habitat_connectivity_simulation_dictionary['simulate_connectivity'] == True:
            Omniscape_normalized_dict = {
                'RAP_Omniscape_transformed_normalized_pixels_' + str(Parameters.get_model_scenario()): ['Aspect','value']
            }
    ...
    def dynamic(self):
        ...
        if habitat_analysis_dictionary['do_habitat_analysis'] == True:
            ...
            if habitat_connectivity_simulation_dictionary['simulate_connectivity'] == True or PHC_simulation_dictionary[
                'simulate_PHCs'] == True:
                self.calculate_umbrella_species_habitat_analysis_inputs()
            if Parameters.get_umbrella_species_ecosystem_fragmentation_analysis_mplc_RAP_analysis_choice() == True:
                self.calculate_umbrella_species_ecosystem_fragmentation()
            if habitat_connectivity_simulation_dictionary['simulate_connectivity'] == True:
                if habitat_connectivity_simulation_dictionary['simulation_in'] == 'RAP' or \
                        habitat_connectivity_simulation_dictionary['simulation_in'] == 'mplc+RAP':
            ...
            if PHC_simulation_dictionary['simulate_PHCs'] == True:
                if PHC_simulation_dictionary['simulation_in'] == 'RAP' or PHC_simulation_dictionary[
                    'simulation_in'] == 'mplc+RAP':
                    if self.year in habitat_analysis_simulation_years_list:
                        self.calculate_umbrella_species_PHCs()
            if Parameters.get_habitat_analysis_averaging_choice() == True and (
                    self.year == Parameters.get_last_simulation_year()):
    ...
    def make_LPB_mplc_log_file_data_for_the_time_step_accessible(self):
        ...
        if a_key in self.LPB_mplc_log_file_dictionary:
            ...
            # LUT19
            self.allocated_pixels_LUT19 = self.LPB_mplc_log_file_dictionary[a_key][107]
            self.percentage_of_landscape_LUT19 = self.LPB_mplc_log_file_dictionary[a_key][108]
            # AGB Mg harvested

            # HIDDEN DEFORESTATION
            self.maximum_deforested_for_input_biomass_area = self.LPB_mplc_log_file_dictionary[a_key][109]
            self.maximum_deforested_for_input_biomass_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][110]

            # CONVERTED FOREST (new land use type)
            self.converted_forest_area = self.LPB_mplc_log_file_dictionary[a_key][111]
            self.converted_forest_area_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][112]

            # LANDSCAPE MODELLING PROBABILITY/UNCERTAINTY
            self.pixels_in_probability_class_1 = self.LPB_mplc_log_file_dictionary[a_key][113]
            self.percentage_of_landscape_probability_class_1 = self.LPB_mplc_log_file_dictionary[a_key][114]
            self.pixels_in_probability_class_2 = self.LPB_mplc_log_file_dictionary[a_key][115]
            self.percentage_of_landscape_probability_class_2 = self.LPB_mplc_log_file_dictionary[a_key][116]
            self.pixels_in_probability_class_3 = self.LPB_mplc_log_file_dictionary[a_key][117]
            self.percentage_of_landscape_probability_class_3 = self.LPB_mplc_log_file_dictionary[a_key][118]
            self.pixels_in_probability_class_4 = self.LPB_mplc_log_file_dictionary[a_key][119]
            self.percentage_of_landscape_probability_class_4 = self.LPB_mplc_log_file_dictionary[a_key][120]
            self.pixels_in_probability_class_5 = self.LPB_mplc_log_file_dictionary[a_key][121]
            self.percentage_of_landscape_probability_class_5 = self.LPB_mplc_log_file_dictionary[a_key][122]
            self.pixels_in_probability_class_6 = self.LPB_mplc_log_file_dictionary[a_key][123]
            self.percentage_of_landscape_probability_class_6 = self.LPB_mplc_log_file_dictionary[a_key][124]
            self.pixels_in_probability_class_7 = self.LPB_mplc_log_file_dictionary[a_key][125]
            self.percentage_of_landscape_probability_class_7 = self.LPB_mplc_log_file_dictionary[a_key][126]

            # LAND USE IN RESTRICTED AREAS
            self.restricted_areas_area = self.LPB_mplc_log_file_dictionary[a_key][127]
            self.restricted_areas_area_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][128]
            self.total_of_land_use_in_restricted_areas_area = self.LPB_mplc_log_file_dictionary[a_key][129]
            self.total_of_land_use_in_restricted_areas_area_percentage_of_restricted_area = self.LPB_mplc_log_file_dictionary[a_key][130]
            self.total_of_new_land_use_in_restricted_areas_area = self.LPB_mplc_log_file_dictionary[a_key][131]
            self.total_of_new_land_use_in_restricted_areas_area_percentage_of_restricted_area = self.LPB_mplc_log_file_dictionary[a_key][132]
            self.total_of_new_land_use_in_restricted_areas_on_former_forest_pixels_area = self.LPB_mplc_log_file_dictionary[a_key][133]
            self.total_of_new_land_use_in_restricted_areas_on_former_forest_pixels_area_percentage_of_restricted_area = self.LPB_mplc_log_file_dictionary[a_key][134]
            self.mplc_disturbed_in_restricted_areas_area = self.LPB_mplc_log_file_dictionary[a_key][135]
            self.mplc_disturbed_in_restricted_areas_percentage_of_restricted_area = self.LPB_mplc_log_file_dictionary[a_key][136]
            self.mplc_undisturbed_in_restricted_areas_area = self.LPB_mplc_log_file_dictionary[a_key][137]
            self.mplc_undisturbed_in_restricted_areas_percentage_of_restricted_area = self.LPB_mplc_log_file_dictionary[a_key][138]

            # FOREST net gross disturbed undisturbed
            self.gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][139]
            self.gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][140]
            self.net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][141]
            self.net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][142]
            self.gross_mplc_disturbed_forest_area = self.LPB_mplc_log_file_dictionary[a_key][143]
            self.gross_mplc_disturbed_forest_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][144]
            self.gross_mplc_undisturbed_forest_area = self.LPB_mplc_log_file_dictionary[a_key][145]
            self.gross_mplc_undisturbed_forest_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][146]
            self.net_mplc_disturbed_forest_area = self.LPB_mplc_log_file_dictionary[a_key][147]
            self.net_mplc_disturbed_forest_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][148]
            self.net_mplc_undisturbed_forest_area = self.LPB_mplc_log_file_dictionary[a_key][149]
            self.net_mplc_undisturbed_forest_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][150]
            self.gross_minus_net_forest_disturbed_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][151]
            self.gross_minus_net_forest_disturbed_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][152]
            self.gross_minus_net_forest_undisturbed_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][153]
            self.gross_minus_net_forest_undisturbed_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][154]

            # TRUE FOREST IMPACTED BY ANTHROPOGENIC FEATURES (LUT08)
            self.true_gross_forest_impacted_by_anthropogenic_features_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][155]
            self.true_gross_forest_impacted_by_anthropogenic_features_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][156]
            self.true_net_forest_impacted_by_anthropogenic_features_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][157]
            self.true_net_forest_impacted_by_anthropogenic_features_mplc_percentage_of_gross_forest = self.LPB_mplc_log_file_dictionary[a_key][158]
            self.true_gross_minus_net_forest_impacted_by_anthropogenic_features_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][159]
            self.true_gross_minus_net_forest_impacted_by_anthropogenic_features_mplc_percentage_of_gross_forest = self.LPB_mplc_log_file_dictionary[a_key][160]

            # FOREST DEGRADATION/REGENERATION
            # 1) degradation
            # degradation low
            self.low_degradation_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][161]
            self.low_degradation_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][162]
            self.low_degradation_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][163]
            self.low_degradation_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][164]
            self.low_degradation_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][165]
            self.low_degradation_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][166]
            # degradation moderate
            self.moderate_degradation_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][167]
            self.moderate_degradation_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][168]
            self.moderate_degradation_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][169]
            self.moderate_degradation_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][170]
            self.moderate_degradation_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][171]
            self.moderate_degradation_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][172]
            # degradation severe
            self.severe_degradation_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][173]
            self.severe_degradation_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][174]
            self.severe_degradation_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][175]
            self.severe_degradation_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][176]
            self.severe_degradation_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][177]
            self.severe_degradation_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][178]
            # degradation absolute (= LUT17 net forest deforested)
            self.absolute_degradation_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][179]
            self.absolute_degradation_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][180]
            self.absolute_degradation_net_forest_disturbed_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][181]
            self.absolute_degradation_net_forest_disturbed_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][182]
            self.absolute_degradation_net_forest_undisturbed_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][183]
            self.absolute_degradation_net_forest_undisturbed_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][184]

            # 2) regeneration
            # regeneration low
            self.low_regeneration_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][185]
            self.low_regeneration_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][186]
            self.low_regeneration_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][187]
            self.low_regeneration_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][188]
            self.low_regeneration_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][189]
            self.low_regeneration_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][190]
            # regeneration medium
            self.medium_regeneration_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][191]
            self.medium_regeneration_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][192]
            self.medium_regeneration_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][193]
            self.medium_regeneration_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][194]
            self.medium_regeneration_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][195]
            self.medium_regeneration_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][196]
            # regeneration high
            self.high_regeneration_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][197]
            self.high_regeneration_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][198]
            self.high_regeneration_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][199]
            self.high_regeneration_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][200]
            self.high_regeneration_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][201]
            self.high_regeneration_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][202]
            # regeneration full (climax stadium, still not all primary forest traits given))
            self.full_regeneration_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][203]
            self.full_regeneration_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][204]
            self.full_regeneration_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][205]
            self.full_regeneration_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][206]
            self.full_regeneration_disturbed_forest_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][207]
            self.full_regeneration_disturbed_forest_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][208]
            self.full_regeneration_disturbed_forest_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][209]
            self.full_regeneration_disturbed_forest_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][210]
            self.full_regeneration_disturbed_forest_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][211]
            self.full_regeneration_disturbed_forest_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][212]
            self.full_regeneration_undisturbed_forest_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][213]
            self.full_regeneration_undisturbed_forest_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][214]
            self.full_regeneration_undisturbed_forest_gross_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][215]
            self.full_regeneration_undisturbed_forest_gross_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][216]
            self.full_regeneration_undisturbed_forest_gross_minus_net_forest_mplc_area = self.LPB_mplc_log_file_dictionary[a_key][217]
            self.full_regeneration_undisturbed_forest_gross_minus_net_forest_mplc_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][218]

            # FOREST AGB in Mg -> tC
            # potential maximum AGB
            self.potential_maximum_undisturbed_forest_AGB_maptotal = self.LPB_mplc_log_file_dictionary[a_key][219]
            self.potential_maximum_undisturbed_forest_AGB_Carbon = self.LPB_mplc_log_file_dictionary[a_key][220]
            # initial AGB simulation start
            self.initial_AGB_maptotal = self.LPB_mplc_log_file_dictionary[a_key][221]
            self.initial_AGB_Carbon = self.LPB_mplc_log_file_dictionary[a_key][222]
            self.initial_AGB_percentage_of_potential_maximum_undisturbed_AGB = self.LPB_mplc_log_file_dictionary[a_key][223]
            # demand AGB for the time step
            self.demand_timber_AGB = self.LPB_mplc_log_file_dictionary[a_key][224]
            self.demand_fuelwood_AGB = self.LPB_mplc_log_file_dictionary[a_key][225]
            self.demand_charcoal_AGB = self.LPB_mplc_log_file_dictionary[a_key][226]
            self.demand_AGB = self.LPB_mplc_log_file_dictionary[a_key][227]
            # final total AGB for the time step
            self.final_AGB_gross_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][228]
            self.final_AGB_gross_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][229]
            self.final_AGB_net_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][230]
            self.final_AGB_net_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][231]
            self.final_AGB_gross_minus_net_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][232]
            self.final_AGB_gross_minus_net_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][233]

            # final AGB agroforestry
            self.final_agroforestry_AGB_maptotal = self.LPB_mplc_log_file_dictionary[a_key][234]
            self.final_agroforestry_AGB_Carbon = self.LPB_mplc_log_file_dictionary[a_key][235]
            # final AGB plantation
            self.final_plantation_AGB_maptotal = self.LPB_mplc_log_file_dictionary[a_key][236]
            self.final_plantation_AGB_Carbon = self.LPB_mplc_log_file_dictionary[a_key][237]
            # final AGB disturbed forest
            self.final_disturbed_forest_AGB_gross_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][238]
            self.final_disturbed_forest_AGB_gross_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][239]
            self.final_disturbed_forest_AGB_net_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][240]
            self.final_disturbed_forest_AGB_net_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][241]
            self.final_disturbed_forest_AGB_net_forest_percentage_of_gross_disturbed_forest = self.LPB_mplc_log_file_dictionary[a_key][242]
            self.final_disturbed_forest_AGB_gross_minus_net_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][243]
            self.final_disturbed_forest_AGB_gross_minus_net_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][244]
            self.final_disturbed_forest_AGB_gross_minus_net_forest_percentage_of_gross_disturbed_forest = self.LPB_mplc_log_file_dictionary[a_key][245]
            # final AGB undisturbed forest
            self.final_undisturbed_forest_AGB_gross_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][246]
            self.final_undisturbed_forest_AGB_gross_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][247]
            self.final_undisturbed_forest_AGB_net_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][248]
            self.final_undisturbed_forest_AGB_net_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][249]
            self.final_undisturbed_forest_AGB_net_forest_percentage_of_gross_undisturbed_forest = self.LPB_mplc_log_file_dictionary[a_key][250]
            self.final_undisturbed_forest_AGB_gross_minus_net_forest_maptotal = self.LPB_mplc_log_file_dictionary[a_key][251]
            self.final_undisturbed_forest_AGB_gross_minus_net_forest_Carbon = self.LPB_mplc_log_file_dictionary[a_key][252]
            self.final_undisturbed_forest_AGB_gross_minus_net_forest_percentage_of_gross_undisturbed_forest = self.LPB_mplc_log_file_dictionary[a_key][253]

            # FOREST REMAINING without direct anthropogenic impact
            # gross forest
            # undisturbed
            self.remaining_gross_undisturbed_forest_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][254]
            self.remaining_gross_undisturbed_forest_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][255]
            # disturbed
            self.remaining_gross_disturbed_forest_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][256]
            self.remaining_gross_disturbed_forest_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][257]
            # net forest
            # undisturbed
            self.remaining_net_undisturbed_forest_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][258]
            self.remaining_net_undisturbed_forest_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][259]
            # disturbed
            self.remaining_net_disturbed_forest_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][260]
            self.remaining_net_disturbed_forest_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][261]
            # gross minus net
            # undisturbed
            self.remaining_gross_minus_net_undisturbed_forest_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][262]
            self.remaining_gross_minus_net_undisturbed_forest_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][263]
            # disturbed
            self.remaining_gross_minus_net_disturbed_forest_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][264]
            self.remaining_gross_minus_net_disturbed_forest_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][265]

            # FOREST 100 years without anthropogenic impact (potential primary stadium)
            # former disturbed forest
            self.former_disturbed_gross_forest_100years_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][266]
            self.former_disturbed_gross_forest_100years_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][267]
            self.former_disturbed_net_forest_100years_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][268]
            self.former_disturbed_net_forest_100years_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][269]
            self.former_disturbed_gross_minus_net_forest_100years_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][270]
            self.former_disturbed_gross_minus_net_forest_100years_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][271]
            # initial undisturbed forest
            self.initial_undisturbed_gross_forest_100years_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][272]
            self.initial_undisturbed_gross_forest_100years_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][273]
            self.initial_undisturbed_net_forest_100years_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][274]
            self.initial_undisturbed_net_forest_100years_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][275]
            self.initial_undisturbed_gross_minus_net_forest_100years_without_impact_area = self.LPB_mplc_log_file_dictionary[a_key][276]
            self.initial_undisturbed_gross_minus_net_forest_100years_without_impact_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][277]

            # FOREST HABITAT DISTURBED AND UNDISTURBED
            self.mplc_disturbed_forest_fringe_area = self.LPB_mplc_log_file_dictionary[a_key][278]
            self.mplc_disturbed_forest_fringe_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][279]
            self.mplc_undisturbed_forest_habitat_area = self.LPB_mplc_log_file_dictionary[a_key][280]
            self.mplc_undisturbed_forest_habitat_percentage_of_landscape = self.LPB_mplc_log_file_dictionary[a_key][281]

            # 5 TOP CROPS YIELDS
            # 1
            self.top_crop_1_share_of_LUT_acreage = self.LPB_mplc_log_file_dictionary[a_key][282]
            self.top_crop_1_yield_minimum = self.LPB_mplc_log_file_dictionary[a_key][283]
            self.top_crop_1_yield_mean = self.LPB_mplc_log_file_dictionary[a_key][284]
            self.top_crop_1_yield_maximum = self.LPB_mplc_log_file_dictionary[a_key][285]
            # 2
            self.top_crop_2_share_of_LUT_acreage = self.LPB_mplc_log_file_dictionary[a_key][286]
            self.top_crop_2_yield_minimum = self.LPB_mplc_log_file_dictionary[a_key][287]
            self.top_crop_2_yield_mean = self.LPB_mplc_log_file_dictionary[a_key][288]
            self.top_crop_2_yield_maximum = self.LPB_mplc_log_file_dictionary[a_key][289]
            # 3
            self.top_crop_3_share_of_LUT_acreage = self.LPB_mplc_log_file_dictionary[a_key][290]
            self.top_crop_3_yield_minimum = self.LPB_mplc_log_file_dictionary[a_key][291]
            self.top_crop_3_yield_mean = self.LPB_mplc_log_file_dictionary[a_key][292]
            self.top_crop_3_yield_maximum = self.LPB_mplc_log_file_dictionary[a_key][293]
            # 4
            self.top_crop_4_share_of_LUT_acreage = self.LPB_mplc_log_file_dictionary[a_key][294]
            self.top_crop_4_yield_minimum = self.LPB_mplc_log_file_dictionary[a_key][295]
            self.top_crop_4_yield_mean = self.LPB_mplc_log_file_dictionary[a_key][296]
            self.top_crop_4_yield_maximum = self.LPB_mplc_log_file_dictionary[a_key][297]
            # 5
            self.top_crop_5_share_of_LUT_acreage = self.LPB_mplc_log_file_dictionary[a_key][298]
            self.top_crop_5_yield_minimum = self.LPB_mplc_log_file_dictionary[a_key][299]
            self.top_crop_5_yield_mean = self.LPB_mplc_log_file_dictionary[a_key][300]
            self.top_crop_5_yield_maximum = self.LPB_mplc_log_file_dictionary[a_key][301]
    ...
    def calculate_RAP_possible_landscape_configuration(self):
        ...
        # LUT19
        self.RAP_allocated_pixels_LUT19 = int(
            maptotal(scalar(boolean(self.possible_landscape_configuration_map == 19))))
        self.RAP_percentage_of_landscape_LUT19 = round(
            float((self.RAP_allocated_pixels_LUT19 / self.hundred_percent_area) * 100), 2)
    ...
    def calculate_umbrella_species_altitude_habitat_environment_map(self):
        ...
        self.umbrella_species_altitudinal_range_environment_map = ifthen(
            scalar(altitude_min_map) <= scalar(altitude_max),
            scalar(self.possible_landscape_configuration_map))

        # if the user defined additional areas that are not potential habitat, extract them here:
        static_excluded_areas_for_umbrella_species_input_map = readmap(
            Filepaths.file_static_excluded_areas_for_umbrella_species_input)
        self.umbrella_species_altitudinal_range_environment_map = ifthen(
            scalar(static_excluded_areas_for_umbrella_species_input_map) != scalar(1),
            self.umbrella_species_altitudinal_range_environment_map)

        pcraster_conform_map_name = 'RAPaltra'
        time_step = self.time_step  # needed for PCRaster conform output
        output_map_name = generate_PCRaster_conform_output_name.generate_PCRaster_conform_output_for_subfolder(
            pcraster_conform_map_name, time_step)
        report(self.umbrella_species_altitudinal_range_environment_map,
               os.path.join(Filepaths.folder_altitude_range_habitat_environment_map_RAP, output_map_name))
        print('self.umbrella_species_altitudinal_range_environment_map created and stored as "RAPaltra" in:',
              Filepaths.folder_altitude_range_habitat_environment_map_RAP)
    ...
    def calculate_umbrella_species_ecosystem_fragmentation(self):
        ...
        report(umbrella_species_ecosystem_fragmentation_map,
               os.path.join(Filepaths.folder_ecosystem_fragmentation_RAP,
                            'umbrella_species_ecosystem_fragmentation.' + output_time_step_suffix))
        ...
        report(clump_map,
               os.path.join(Filepaths.folder_ecosystem_fragmentation_PatchID_RAP,
    ...
    def calculate_umbrella_species_habitat_analysis_inputs(self):
        ...
        report(report_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_resistance_map, report_map_time_step_name))

        # transform to .asc as input file
        in_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_resistance_map, report_map_time_step_name)
        out_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_resistance_ascii,
                               'resistances_time_step_' + output_time_step_suffix + '.asc')
        map_to_asc(in_map, out_map)

        # save ascii file path for use in analysis
        self.resistances_file_time_step = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_resistance_ascii,
                                                       'resistances_time_step_' + output_time_step_suffix + '.asc')
        ...
        for a_LUT, a_source_value in user_defined_habitat_analysis_dictionary_sources.items():
            temp_source_map = ifthen(scalar(self.possible_landscape_configuration_map) == scalar(a_LUT),
        ...
        report(report_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_sources_map, report_map_time_step_name))

        # transform to .asc as input file
        in_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_sources_map, report_map_time_step_name)
        out_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_sources_ascii,
                               'sources_time_step_' + output_time_step_suffix + '.asc')
        map_to_asc(in_map, out_map)

        # save ascii file path for use in analysis
        self.sources_file_time_step = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_sources_ascii,
                                                   'sources_time_step_' + output_time_step_suffix + '.asc')
        ...
        report(report_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_grounds_map, report_map_time_step_name))

        # transform to .asc as input file
        in_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_grounds_map, report_map_time_step_name)
        out_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_grounds_ascii,
                               'grounds_time_step_' + output_time_step_suffix + '.asc')
        map_to_asc(in_map, out_map)

        # save ascii file path for use in analysis
        self.grounds_file_time_step = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_grounds_ascii,
                                                   'grounds_time_step_' + output_time_step_suffix + '.asc')
        ...
        report(report_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_polygons_map, report_map_time_step_name))

        # transform to .asc as input file
        in_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_polygons_map, report_map_time_step_name)
        out_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_polygons_ascii,
                               'polygons_time_step_' + output_time_step_suffix + '.asc')
        map_to_asc(in_map, out_map)

        # save ascii file path for use in analysis
        self.polygons_file_time_step = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_polygons_ascii,
                                                    'polygons_time_step_' + output_time_step_suffix + '.asc')
        ...
        report(report_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_points_map, report_map_time_step_name))

        # transform to .asc as input file
        in_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_points_map, report_map_time_step_name)
        out_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_points_ascii,
                               'points_time_step_' + output_time_step_suffix + '.asc')
        map_to_asc(in_map, out_map)

        # save ascii file path for use in analysis
        self.points_file_time_step = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_points_ascii,
                                                  'points_time_step_' + output_time_step_suffix + '.asc')
        ...
        report(report_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_habitat_map, report_map_time_step_name))

        # transform to .asc as input file
        in_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_habitat_map, report_map_time_step_name)
        out_map = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_habitat_ascii,
                               'habitat_time_step_' + output_time_step_suffix + '.asc')
        map_to_asc(in_map, out_map)

        # save ascii file path for use in analysis
        self.habitat_file_time_step = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_habitat_ascii,
                                                   'habitat_time_step_' + output_time_step_suffix + '.asc')
        ...
        if habitat_connectivity_simulation_dictionary['simulate_connectivity'] == True:
            ...
            report(report_map,
                   os.path.join(
                       Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape_transformed_normalized_reclassified,
        ...
        if PHC_simulation_dictionary['simulate_PHCs'] == True:
            ...
            report(report_map,
                   os.path.join(
                       Filepaths.folder_habitat_analysis_RAP_outputs_Circuitscape_transformed_voltmap_rescaled,
                       report_map_time_step_name))
    ...
    def calculate_umbrella_species_habitat_connectivity(self):
        ...
        Omiscape_outputs_folder = Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape
        ...
        # save to a file
        Omniscape_time_step_configuration_ini_LPBRAP = os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs_Omniscape_ini_files, Omniscape_configuration_ini_time_step)
        ...
        if LPBRAP_Omniscape_settings_dictionary['simulation_buffer_integrated'] == False:
            ...
            in_filename_ascii = os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape,
                                             str('Connectivity_time_step_' + output_time_step_suffix),
                                             'normalized_cum_currmap.asc')
            extended_analysis_output_map = asc_to_map(
                clone=os.path.join(Filepaths.folder_habitat_analysis_RAP_inputs, 'setclone_extended_input.map'),
            ...
            ## get the file
            normalized_cumulative_current_map_time_step_ascii = os.path.join(
                Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape,
                str('Connectivity_time_step_' + output_time_step_suffix),
                'normalized_cum_currmap.asc')
            ## transform it
            normalized_cumulative_current_map_time_step_map = asc_to_map(
                (f"{Filepaths.file_static_null_mask_input}.map"), normalized_cumulative_current_map_time_step_ascii)

        ## save for visualization in R
        report(normalized_cumulative_current_map_time_step_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape_PCRaster_normalized,
                            'normalized_cum_currmap.' + output_time_step_suffix))
        ...
        if LPBRAP_Omniscape_settings_dictionary['simulation_buffer_integrated'] == False:
            ...
            ## get the file
            cumulative_current_map_time_step_ascii = os.path.join(
                Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape,
                str('Connectivity_time_step_' + output_time_step_suffix),
                'cum_currmap.asc')
            ## transform it
            cumulative_current_map_time_step_map = asc_to_map((f"{Filepaths.file_static_null_mask_input}.map"),
                                                              cumulative_current_map_time_step_ascii)
        ## save for visualization in R
        report(cumulative_current_map_time_step_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape_PCRaster_cumulative,
                            'cum_currmap.' + output_time_step_suffix))
        ...
        if LPBRAP_Omniscape_settings_dictionary['simulation_buffer_integrated'] == False:
            ...
            ## get the file
            flow_potential_map_time_step_ascii = os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape,
                                                              str('Connectivity_time_step_' + output_time_step_suffix),
                                                              'flow_potential.asc')
            ## transform it
            flow_potential_map_time_step_map = asc_to_map((f"{Filepaths.file_static_null_mask_input}.map"),
                                                          flow_potential_map_time_step_ascii)
        ## save for visualization in R
        report(flow_potential_map_time_step_map,
               os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Omniscape_PCRaster_flow,
                            'flow_potential.' + output_time_step_suffix))
        ...
        for a_class, a_description_dict in reclassification_dict.items():
            for a_description, a_formula_dict in a_description_dict.items():
                ...
                singular_class_map = ifthen(
                    condition(scalar(normalized_cumulative_current_map_time_step_map), a_threshold, an_operand),
                    scalar(a_class))
                self.Omniscape_normalized_cumulative_current_reclassified_map_time_step_map = cover(
                    scalar(singular_class_map),
                ...
                if a_description == 'reduced_flow':
                    ...
                    self.Omniscape_normalized_channelized_flow = int(maptotal(scalar(boolean(
                        scalar(self.Omniscape_normalized_cumulative_current_reclassified_map_time_step_map) == scalar(
                            a_class)))))
    ...
    def calculate_umbrella_species_PHCs(self):
        ...
        # update further options
        config.set('Options for advanced mode', 'ground_file_is_resistances',
                   str(LPBRAP_Circuitscape_settings_dictionary['ground_file_is_resistances']))
        config.set('Options for advanced mode', 'remove_src_or_gnd',
                   str(LPBRAP_Circuitscape_settings_dictionary['remove_src_or_gnd']))
        config.set('Options for advanced mode', 'use_unit_currents',
                   str(LPBRAP_Circuitscape_settings_dictionary['use_unit_currents']))
        config.set('Options for advanced mode', 'use_direct_grounds',
                   str(LPBRAP_Circuitscape_settings_dictionary['use_direct_grounds']))

        config.set('Output options', 'set_null_currents_to_nodata',
                   str(LPBRAP_Circuitscape_settings_dictionary['set_null_currents_to_nodata']))
        config.set('Output options', 'set_null_voltages_to_nodata',
                   str(LPBRAP_Circuitscape_settings_dictionary['set_null_voltages_to_nodata']))

        config.set('Short circuit regions (aka polygons)', 'use_polygons',
                   str(LPBRAP_Circuitscape_settings_dictionary['use_polygons']))

        config.set('Connection scheme for raster habitat data', 'connect_four_neighbors_only',
                   str(LPBRAP_Circuitscape_settings_dictionary['connect_four_neighbors_only']))
        config.set('Connection scheme for raster habitat data', 'connect_using_avg_resistances',
                   str(LPBRAP_Circuitscape_settings_dictionary['connect_using_avg_resistances']))
        ...
        Circuitscape_outputs_folder = Filepaths.folder_habitat_analysis_RAP_outputs_Circuitscape
        ...
        # save to a file
        Circuitscape_time_step_configuration_ini_LPBRAP = os.path.join(
            Filepaths.folder_habitat_analysis_RAP_inputs_Circuitscape_ini_files,
        ...
        if PHC_simulation_dictionary['simulation_scenario'] == 'advanced':
            ...
            if LPBRAP_Omniscape_settings_dictionary['simulation_buffer_integrated'] == False:
                ...
                _setclone_extended()
                # load and transform analysis output map
                in_filename_ascii = os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Circuitscape,
                ...
                curmap_time_step_ascii = os.path.join(
                    Filepaths.folder_habitat_analysis_RAP_outputs_Circuitscape,
                    str('PHCs_time_step_' + output_time_step_suffix + '_curmap.asc'))
                ## transform it
                curmap_time_step_map = asc_to_map((f"{Filepaths.file_static_null_mask_input}.map"),
                                                  curmap_time_step_ascii)
            ## save for visualization in R
            report(curmap_time_step_map,
                   os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Circuitscape_to_PCRaster_curmap,
                                'curmap.' + output_time_step_suffix))
            ...
            if LPBRAP_Omniscape_settings_dictionary['simulation_buffer_integrated'] == False:
                ...
                voltmap_time_step_ascii = os.path.join(
                    ...
                    str('PHCs_time_step_' + output_time_step_suffix + '_voltmap.asc'))
                ## transform it
                voltmap_time_step_map = asc_to_map((f"{Filepaths.file_static_null_mask_input}.map"),
                                                   voltmap_time_step_ascii)
            ## save for visualization in R
            report(voltmap_time_step_map,
                   os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Circuitscape_to_PCRaster_voltmap,
                                'voltmap.' + output_time_step_suffix))
        ...
        if PHC_simulation_dictionary['simulation_scenario'] == 'pairwise':
            ...
            if LPBRAP_Omniscape_settings_dictionary['simulation_buffer_integrated'] == False:
                ...
                cum_curmap_time_step_ascii = os.path.join(
                    ...
                    str('PHCs_time_step_' + output_time_step_suffix + '_cum_curmap.asc'))
                ## transform it
                cum_curmap_time_step_map = asc_to_map((f"{Filepaths.file_static_null_mask_input}.map"),
                                                  cum_curmap_time_step_ascii)
            ## save for visualization in R
            report(cum_curmap_time_step_map,
                   os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs_Circuitscape_to_PCRaster_cum_curmap,
        ...
        if PHC_simulation_dictionary['simulation_scenario'] == 'advanced':
            ...
            numpy_pure_voltmap_rescaled = numpy.interp(numpy_pure_voltmap,
                                                       (numpy_pure_voltmap.min(), numpy_pure_voltmap.max()), (0.01, +1))
            ...
            self.Circuitscape_rescaled_voltmap_time_step_map = cover(scalar(pure_voltmap_rescaled), scalar(
                self.Circuitscape_rescaled_voltmap_time_step_map))
    ...
    def calculate_umbrella_species_averaged_time_frames(self):
        ...
        simulation_years_complete_list = list(
            range(Parameters.get_initial_simulation_year(), Parameters.get_last_simulation_year() + 1))
        ...
        if PHC_simulation_dictionary['simulation_scenario'] == 'advanced':
            ...
            for a_period, a_time_step_list in user_defined_time_steps_for_averaging_dictionary_of_lists.items():
                ...
                output_file_path = os.path.join(Filepaths.folder_habitat_analysis_RAP_outputs,
                                                'LPB-RAP_averaged_results')
    ...
    def export_data_to_LPB_RAP_log_file(self):
        ...
        with open(os.path.join(Filepaths.folder_RAP_CSVs, 'LPB-RAP_log-file.csv'),'a', newline='') as LPB_RAP_log_file:
            ...
            LPB_RAP_log_file_data = [self.time_step,
                                     ...
                                     # LUT19-RAP
                                     self.RAP_allocated_pixels_LUT19,
                                     self.RAP_percentage_of_landscape_LUT19,
    ...
    def export_data_to_tidy_data_folder(self):
        ...
        output_files_data = {
            'RAP_land_use_' + str(Parameters.get_model_scenario()): [
                ...
                ['LUT19', self.RAP_allocated_pixels_LUT19, self.RAP_percentage_of_landscape_LUT19],
        ...
        if habitat_connectivity_simulation_dictionary['simulate_connectivity'] == True:
            Omniscape_normalized_output_dict = {
                'RAP_Omniscape_transformed_normalized_pixels_' + str(Parameters.get_model_scenario()): [
