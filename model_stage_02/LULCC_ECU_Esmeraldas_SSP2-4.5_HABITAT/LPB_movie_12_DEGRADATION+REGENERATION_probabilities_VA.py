"""LAFORET-PLUC-BE-RAP/SFM - LPB mplc degradation and regeneration probabilities
...
list_all_names = {1:'1 = 0 % probability == 8',
...
in_fn = os.path.join(Filepaths.folder_FOREST_PROBABILITY_MAPS_degradation_and_regeneration_probabilities_classified,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - forest degradation/regeneration (dist.+undist.) probabilities classified')
