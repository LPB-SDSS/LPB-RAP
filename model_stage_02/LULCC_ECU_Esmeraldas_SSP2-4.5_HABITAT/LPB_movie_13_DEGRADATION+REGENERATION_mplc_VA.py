"""LAFORET-PLUC-BE-RAP/SFM - Degradation/Regeneration
...
colormap_d = mpl.colormaps['magma']
colormap_r = mpl.colormaps['viridis']
import numpy as np
...
list_all_names = {4:'= degradation absolute',
                  3:'= degradation severe',
                  2:'= degradation moderate',
                  1:'= degradation low',
                  5:'= regeneration low',
                  6:'= regeneration medium',
                  7:'= regeneration high',
                  8:'= regeneration full',
                  9:'= region',
                  10:'= gross forest area'}
...
in_fn = os.path.join(Filepaths.folder_FOREST_PROBABILITY_MAPS_degradation_and_regeneration,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - forest disturbed and undisturbed degradation and regeneration')
