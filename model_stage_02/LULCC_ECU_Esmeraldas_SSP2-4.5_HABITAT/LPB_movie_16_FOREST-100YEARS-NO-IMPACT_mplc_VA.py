"""LAFORET-PLUC-BE-RAP/SFM - LPB mplc forest a 100 years without impact
...
list_all_names = {1:'= gross forest 100 years without impact',
                  2:'= net forest 100 years without impact',
                  8:'= region',
                  9:'= restricted areas'}
...
in_fn = os.path.join(Filepaths.folder_100years_no_impact_forest_mplc,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - forest a 100 years without anthropogenic impact')
