"""LAFORET-PLUC-BE-RAP/SFM - LPB mplc forest net gross probabilities
...
in_fn = os.path.join(Filepaths.folder_FOREST_PROBABILITY_MAPS_fng_mplc_probabilities_classified,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - forest (types) net and gross forest probabilities classified')
