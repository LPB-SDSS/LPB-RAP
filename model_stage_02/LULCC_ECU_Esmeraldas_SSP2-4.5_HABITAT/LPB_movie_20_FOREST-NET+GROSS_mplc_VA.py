"""LAFORET-PLUC-BE-RAP/SFM - LPB mplc net and gross forest
...
list_all_names = {1:' = region',
                   2:' = disturbed and undisturbed NET forest in GROSS forest',
                   3:' = remaining disturbed and undisturbed forest in GROSS forest',
                   4:' = agrofrestry in GROSS forest',
                   5:' = plantations in GROSS forest'}
...
in_fn = os.path.join(Filepaths.folder_FOREST_PROBABILITY_MAPS_fng_mplc,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - forest (types) in net and gross forest')
