"""LAFORET-PLUC-BE-RAP/SFM - LPB mplc probabilities
...
in_fn = os.path.join(Filepaths.folder_LULCC_mplc_probabilities_classified,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - most probable landscape configuration probabilities classified')
