"""LAFORET-PLUC-BE-RAP/SFM - LPB mplc forest remaining without impact
...
list_all_names = {1:'= gross disturbed forest without impact',
                  2:'= gross undisturbed forest without impact',
                  3:'= net disturbed forest without impact',
                  4:'= net undisturbed forest without impact',
                  8:'= region',
                  9:'= restricted areas'}
...
in_fn = os.path.join(Filepaths.folder_remaining_no_impact_forest_mplc,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - remaining forest without direct anthropogenic impact')
