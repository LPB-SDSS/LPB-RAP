...
list_all_names = {1:' = region',
                   2:' = disturbed forest outside net forest',
                   3:' = undisturbed forest outside net forest',
                   4:' = disturbed forest inside net forest',
                   5:' = undisturbed forest inside net forest'}
...
in_fn = os.path.join(Filepaths.folder_FOREST_PROBABILITY_MAPS_fud_mplc,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - forest disturbed and undisturbed in net and gross forest')
