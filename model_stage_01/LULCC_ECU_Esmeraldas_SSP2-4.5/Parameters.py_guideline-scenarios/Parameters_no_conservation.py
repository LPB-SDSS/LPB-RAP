...
def get_model_scenario():
    ...
    model_scenario = 'no_conservation'
...
def get_number_of_time_steps():
    ...
    time_steps = 76  ##SH: (2018 standard 83, 2025 -> 76)
    return time_steps
...
def get_maximum_age_forest():
    ...
    maximum_age_forest = 44  # years (36 for 2018, 44 for 2025)
...
def get_net_forest_percentage_increment_goal():
    ...
    percentage_increment_net_forest_area = 7.38  # % (UN, 2017: 3 or calculated for no conservation scenario: see weak or enforced conservation output RAP CSV output) 13.734
