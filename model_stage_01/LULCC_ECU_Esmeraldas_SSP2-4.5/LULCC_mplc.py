...
class MostProbableLandscapeConfiguration(DynamicModel):
    ...
    def dynamic(self):
        ...
        if self.PHCs_simulation_choice_dictionary['simulate_PHCs'] == True and (self.PHCs_simulation_choice_dictionary['simulation_in'] == 'mplc'
    ...
    def calculate_fragmentation(self):
        ...
        list_of_input_LUTs = Parameters.get_fragmentation_mplc()

        # extract the boolean landscape
        analysis_input_map = boolean(self.null_mask_map)
        for a_LUT in list_of_input_LUTs:
            a_LUT_map = ifthen(scalar(self.most_probable_landscape_configuration_map) == scalar(a_LUT),
                               boolean(1))
        ...
        # perform the analysis on landscape (return) and singular patches (csv output) in PylandStats
        module = 'mplc'
