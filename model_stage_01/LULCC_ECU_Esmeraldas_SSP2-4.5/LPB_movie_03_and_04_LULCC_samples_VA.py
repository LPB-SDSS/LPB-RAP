"""LAFORET-PLUC-BE-RAP/SFM - LPB_movie_land_use VIRIDIS ACCESSIBLE
...
im_ani = animation.FuncAnimation(f, animate, interval=300, \
                                   ...
                                   init_func=init)
im_ani.save(os.path.join(Filepaths.folder_GIFs, 'LPB_movie_03_LULCC_sample_1_' + country +'_' + region + '_' + baseline_scenario + '_' + model_scenario +'_scenario_VA.gif'), dpi=300, metadata={'artists':'Judith Verstegen & Sonja Holler'})
...
im_ani = animation.FuncAnimation(f, animate, interval=300, \
                                   blit=False, frames = timesteps,\
                                   init_func=init)
im_ani.save(os.path.join(Filepaths.folder_GIFs, 'LPB_movie_04_LULCC_sample_' + str(number_of_samples_set) + '_' + country +'_' + region + '_' + baseline_scenario + '_' + model_scenario +'_scenario_VA.gif'), dpi=300, metadata={'artists':'Judith Verstegen & Sonja Holler'})
