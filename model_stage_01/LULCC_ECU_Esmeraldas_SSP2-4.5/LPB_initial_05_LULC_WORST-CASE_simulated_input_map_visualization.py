"""LAFORET-PLUC-BE-RAP/SFM - worst case input map visualization
...
im_ani = animation.FuncAnimation(f, animate, interval=300, \
                                   ...
                                   init_func=init)
im_ani.save(os.path.join(Filepaths.folder_GIFs, filename +'_' + country +'_' + region + '_' + baseline_scenario + ' ' + model_scenario +'_scenario_' + str(init_year) + '.gif'), dpi=300, metadata={'artists':'Judith Verstegen & Sonja Holler'})
