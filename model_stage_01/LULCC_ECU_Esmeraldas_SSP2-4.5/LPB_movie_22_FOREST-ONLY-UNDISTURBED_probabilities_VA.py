"""LAFORET-PLUC-BE-RAP/SFM - forest undisturbed probabilities
...
in_fn = os.path.join(Filepaths.folder_FOREST_PROBABILITY_MAPS_undisturbed_probabilities_classified,  fn + nr_zeros * '0' + '.001')
setclone(in_fn)
amap = readmap(in_fn)
...
def animate(i):
    ...
    title_annotation.set_text(' - forest undisturbed probabilities classified')
