"""LAFORET-PLUC-BE-RAP/SFM - simulated input map VIRIDIS ACCESSIBLE
...
fn = 'initial_LULC_simulated_input.map'
...
def animate(i):
    ...
    title_annotation.set_text(' - Copernicus based hybrid map after correction step')
    title.set_text('LPB LULCC SIMULATION - after correction step')
    return im, leg, year, subtitle, title_annotation, title
